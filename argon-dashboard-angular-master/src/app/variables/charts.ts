...
export const chartExample2 = {
  ...
  data: {
    labels: ["PG: 0070_03_01", "Unknown process"],
    datasets: [
      {
        label: "Sales",
        data: [2100,1050]
...
export const chartExample3 = {
  ...
  data: {
    labels: ["Tool: 7005", "Tool: 7006","Tool: 7007"],
    datasets: [
      {
        label: "Sales",
        data: [550,590,1010]
...
export const chartExample4 = {
  ...
  data: {
    labels: ["7:00 - 7:59", "8:00 - 8:59","9:00 - 9:59","10:00 - 10:59"],
    datasets: [
      {
...
export const chartExample6 = {
  options: {
    ...
    title: {
      display: true,
      text: 'In Detail : Stand Still Time'
  }
  },
